...
export const thisStory: Story = {
  id: 'resonance-thieves', // Unique identifier for the story
  title: 'The Resonance Thieves', // Title of the story
  date: '2025-06-01', // Publication date in YYYY-MM-DD format
  slug: 'resonance-thieves', // URL-friendly version of the title (e.g. title-with-dashes, lowercase)
  excerpt: 'When Zara discovers that metamaterials can steal energy from parallel dimensions, she must choose between solving Earth\'s energy crisis and preventing the collapse of infinite realities.', // Hook sentence for the story, no spoilers!!
  imageUrl: 'assets/resonance-thieves.png', // Path to the story's image
  tags: ["metamaterials", "parallel-dimensions", "energy-harvesting", "topology", "multiverse"], // Array of tags related to the story, can be multi-word, lower-case, hyphenated (e.g. ["climate", "health"])  
  content: `
...
The age of resonance theft was over. The age of multiversal cooperation had begun.`, // The full story content in Markdown format
  references: [   // Array of up to 5 references to academic papers or reputable news articles that support the science in the story
    {
      ...
      url: "https://www.nature.com/articles/s41586-025-08948-6",
      description: "The foundational research paper that demonstrates how gyromagnetic double-zero-index metamaterials can generate spatio-temporal vortices at topological phase transition points, providing the scientific basis for the metamaterial technology in the story."
    },
    {
      id: 2,
      title: "Light reflects as a vortex off a metamaterial with unusual optical properties",
      url: "https://www.nature.com/articles/d41586-025-01624-9",
      description: "Nature's research briefing explaining the discovery of spatio-temporal vortex generation in yttrium iron garnet metamaterials, supporting the story's portrayal of metamaterial energy manipulation."
    },
    {
      id: 4,
      title: "Topological transitions and topological beam splitters in gyromagnetic metamaterials",
      url: "https://journals.aps.org/prb/abstract/10.1103/PhysRevB.109.085429",
      description: "Research on topological phase transitions in gyromagnetic metamaterials, supporting the story's exploration of quantum tunneling and dimensional energy transfer through metamaterial networks."
    },
    {
      id: 5,
      title: "YIG Photonic Crystals",
      url: "https://arxiv.org/abs/2412.05361",
      description: "Recent research on nanofabricated yttrium iron garnet photonic crystals, relevant to the story's portrayal of YIG metamaterial fabrication and their unique electromagnetic properties."
    }
  ]
};
