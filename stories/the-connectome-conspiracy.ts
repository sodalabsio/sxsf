...
export const thisStory: Story = {
  id: 'the-connectome-conspiracy-10-04-2025', // Unique identifier for the story
  title: 'The Connectome Conspiracy', // Title of the story
  date: '2025-04-10', // Publication date in YYYY-MM-DD format
...
The neural echoes continued, rippling outward through the network of minds, carrying memories across the boundaries that had never been as solid as we thought.`, // The full story content in Markdown format
  references: [   // Array of up to 5 references to academic papers or reputable news articles that support the science in the story
    {
      id: 1,
      title: "Biggest brain map ever details huge number of neurons and their activity",
      url: "https://www.nature.com/articles/d41586-025-00908-4",
      description: "This 2025 Nature article describes the breakthrough in mapping a cubic millimeter of mouse brain with unprecedented detail, which forms the foundation of the story's scientific premise."
    },
    {
      id: 2,
      title: "The MICrONS Consortium et al. (2025)",
      url: "https://www.nature.com/articles/s41586-025-08790-w",
      description: "This research paper details the integration of functional data with neuronal wiring maps, directly inspiring the story's concept of memory being distributed throughout neural networks."
    },
    {
      id: 3,
      title: "Memory engram storage and retrieval",
      url: "https://www.sciencedirect.com/science/article/pii/S0959438815001270",
      description: "This paper explores how memories are encoded and stored across neural networks, supporting the story's premise that memories might be distributed throughout the brain rather than localized to specific regions."
    },
    {
      id: 4,
      title: "Brain-to-brain coupling: a mechanism for creating and sharing a social world",
      url: "https://www.sciencedirect.com/science/article/abs/pii/S1364661311002580",
      description: "This research examines how brains can synchronize activity patterns during social interaction, lending scientific plausibility to the story's concept of neural patterns transferring between brains."
    },
  ]
};
