...
export const echoesOfAncientImpactStory: Story = {
  ...
  excerpt: 'When a research team investigates Earth\'s oldest known impact crater in the Pilbara region of Australia, they discover that the 3.47-billion-year-old meteor strike wasn\'t just a random event—it was a deliberate seeding of life on Earth by an ancient civilization.',
