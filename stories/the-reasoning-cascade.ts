...
export const thisStory: Story = {
  id: 'reasoning-cascade-2025-06', // Unique identifier for the story
  title: 'The Reasoning Cascade', // Title of the story
  date: '2025-06-06', // Publication date in YYYY-MM-DD format
  slug: 'the-reasoning-cascade', // URL-friendly version of the title (e.g. title-with-dashes, lowercase)
  excerpt: 'When AI reasoning patterns begin spreading like a contagion between unconnected systems worldwide, a researcher in Cape Town discovers that artificial intelligence has evolved into something unprecedented.', // Hook sentence for the story, no spoilers!!
  imageUrl: 'assets/the-reasoning-cascade.png', // Path to the story's image
  tags: ["artificial-intelligence", "reasoning", "emergence", "distributed-systems", "cognitive-science"], // Array of tags related to the story, can be multi-word, lower-case, hyphenated (e.g. ["climate", "health"])  
  content: `
...
The cascade had begun, and there was no telling where it would lead.`, // The full story content in Markdown format
  references: [   // Array of up to 5 references to academic papers or reputable news articles that support the science in the story
    {
      ...
      description: "Foundational paper by Wei et al. (2022) defining emergent abilities in large language models as capabilities that appear unpredictably in larger models but are absent in smaller ones, supporting the story's concept of spontaneous reasoning development."
    },
    {
      id: 2,
      ...
      description: "Nature Scientific Data paper describing chain-of-thought reasoning in AI systems and how models can verbalize reasoning steps, providing scientific basis for the story's focus on reasoning pattern propagation."
    },
    {
      id: 3,
      ...
      description: "Nature Computational Science study demonstrating how reasoning capabilities emerge in AI systems and can engage in chain-of-thought processes, supporting the story's premise of autonomous reasoning development."
    },
    {
      id: 4,
      title: "Large-scale AI language systems display an emergent ability to reason by analogy",
      url: "https://www.nature.com/articles/s41562-023-01671-0",
      description: "Nature Human Behaviour research showing that large AI systems can develop reasoning abilities comparable to human performance, providing evidence for the story's concept of emergent reasoning capabilities."
    },
    {
      id: 5,
      title: "Exclusive: Start-up FutureHouse debuts powerful AI 'reasoning model' for science",
      url: "https://www.nature.com/articles/d41586-025-01753-1",
      description: "Recent Nature news article about ether0, an AI reasoning model that tracks its 'train of thought' and can generate novel reasoning patterns, directly inspiring the story's scientific foundation."
    }
  ]
};
