...
export const thisStory: Story = {
  id: 'solar-script', // Unique identifier for the story
  title: 'Solar Script', // Title of the story
  date: '2025-06-13', // Publication date in YYYY-MM-DD format
  slug: 'solar-script', // URL-friendly version of the title (e.g. title-with-dashes, lowercase)
  excerpt: 'When a citizen scientist discovers her homemade solar weather model is actually rewriting the Sun\'s magnetic field, she must choose between blinding a newly conscious star or risking humanity\'s survival.', // Hook sentence for the story, no spoilers!!
  imageUrl: 'assets/solar-script.png', // Path to the story's image
  tags: ["solar-physics", "citizen-science", "consciousness", "quantum-computing", "space-weather"], // Array of tags related to the story, can be multi-word, lower-case, hyphenated (e.g. ["climate", "health"])  
  content: `The tea warehouse had been empty for three years when Selene Rao moved her quantum rig into the corner where her grandmother once stored Earl Grey. The building perched on a terraced slope in the Dhar-Pahar Valley, its corrugated roof catching the thin Himalayan air like a sail. Through gaps in the weathered walls, she could see the neutrino observatory's entrance—a concrete mouth bored straight through the mountain.
  ...
  references: [   // Array of up to 5 references to academic papers or reputable news articles that support the science in the story
    {
      ...
      url: "https://www.science.org/doi/10.1126/science.adq0872",
      description: "The foundational research demonstrating real-time magnetohydrodynamic modeling of the solar corona using data assimilation techniques, which inspired the SUNDRIVE concept in the story."
    },
    {
      id: 2,
      title: "Solar Jet Hunter: a citizen science initiative to identify coronal jets in EUV data sets",
      url: "https://arxiv.org/abs/2309.14871",
      description: "A real citizen science project that demonstrates how volunteers can contribute to solar physics research by analyzing over 120,000 solar images, providing the model for distributed solar observation networks."
    },
    {
      id: 4,
      title: "Quantum Field-Theoretical Description of Neutrino Oscillations in a Magnetic Field and the Solar Neutrino Problem",
      url: "https://link.springer.com/article/10.1134/S1063776122080118",
      description: "Technical paper exploring how neutrino oscillations are affected by magnetic fields in the solar environment, providing the scientific basis for the quantum tunneling mechanism in the story."
    }
  ]
};
