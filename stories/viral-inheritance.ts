...
export const thisStory: Story = {
  id: 'viral-inheritance-2025', // Unique identifier for the story
  title: 'The Viral Inheritance', // Title of the story
  date: '2025-05-08', // Publication date in YYYY-MM-DD format
  slug: 'the-viral-inheritance', // URL-friendly version of the title
  excerpt: 'When a brilliant genetic engineer discovers that an ancient viral legacy in our DNA might be the key to our survival, she must decide whether to embrace this inheritance or fear it.', // Hook sentence for the story
  imageUrl: 'assets/the-viral-inheritance.png', // Path to the story's image
  tags: ["genetics", "evolution", "climate-change", "biotechnology", "viral-dna"], // Array of tags related to the story
...
Amara nodded, thinking about the billions of years of evolutionary history encoded in every human cell—a legacy of survival, adaptation, and cooperation that had been waiting all along for humanity to remember its inheritance.`,
  references: [
    {
      id: 1,
      title: "Latent infection of an active giant endogenous virus in a unicellular green alga",
      url: "https://www.science.org/doi/10.1126/science.ads6303",
      description: "This 2025 research paper describes the discovery of punuivirus in Chlamydomonas reinhardtii and its ability to integrate into the host genome while remaining dormant. The paper details how the virus encodes Fanzor nucleases, which are RNA-guided DNA-cutting enzymes."
    },
    {
      id: 2,
      title: "Fanzor is a eukaryotic programmable RNA-guided endonuclease",
      url: "https://www.nature.com/articles/s41586-023-06356-2",
      description: "This 2023 paper describes how Fanzor proteins function as RNA-guided DNA endonucleases and their potential applications in genome editing. The research demonstrates that these systems can be reprogrammed to target specific DNA sequences."
    },
    {
      id: 3,
      ...
      description: "This review article discusses how viral genetic material has been incorporated into animal genomes throughout evolutionary history, providing scientific grounding for the story's concept that humans might carry dormant viral elements from ancient infections."
    },
    {
      id: 4,
      title: "Chlamydomonas as a model for biofuels and bio-products production",
      url: "https://pmc.ncbi.nlm.nih.gov/articles/PMC5531182/",
      description: "This paper reviews the applications of Chlamydomonas reinhardtii in biofuel production and biotechnology, providing context for the protagonist's background as an algal biotechnology researcher."
    },
    {
      id: 5,
      title: "The hologenome concept of evolution: a philosophical and biological critique",
      url: "https://philarchive.org/rec/SURTHC",
      description: "This article examines the concept that organisms evolve as 'holobionts' - integrated units of host and microbiome, including viral elements. It provides theoretical support for the story's exploration of how viral integrations might influence human evolution and cognition."
    }
  ]
};
