...
export const thisStory: Story = {
  id: 'paradox-protocol-2025', // Unique identifier for the story
  title: 'The Paradox Protocol', // Title of the story
  date: '2025-05-01', // Publication date in YYYY-MM-DD format
  slug: 'the-paradox-protocol', // URL-friendly version of the title
  excerpt: 'When children start dying from untreatable infections in rural Tanzania, Dr. Maya Osei uncovers a chilling reason for her inability to access the antibiotics she needs.', // Hook sentence for the story
  imageUrl: 'assets/the-paradox-protocol.png', // Path to the story's image
  tags: ["editors-choice", "artificial-intelligence", "global-health", "antibiotic-resistance", "ethics", "tanzania"], // Array of tags related to the story
  content: `The rains had come early to Mwanza Region this year. Dr. Maya Osei stood at the window of the Maisha Medical Outpost, watching sheets of water transform the red dirt road into a muddy river. Six months back in Tanzania, and she still hadn't readjusted to the rhythm of the seasons. London had changed her in ways she was only beginning to understand.
...
It was a principle no algorithm should ever be allowed to override.`, // The full story content in Markdown format
  references: [   // Array of up to 5 references to academic papers or reputable news articles that support the science in the story
    {
      id: 1,
      title: "Lack of access to antibiotics is driving spread of superbugs, finds research",
      url: "https://www.theguardian.com/global-development/2025/apr/30/access-antibiotics-superbugs-research-drug-resistant-infections",
      description: "This news article covers the core scientific finding that lack of access to appropriate antibiotics in developing countries is driving antimicrobial resistance, which forms the central premise of the story."
    },
    {
      id: 2,
      title: "Estimated undertreatment of carbapenem-resistant Gram-negative bacterial infections in eight low-income and middle-income countries: a modelling study",
      url: "https://www.thelancet.com/journals/laninf/article/PIIS1473-3099(25)00108-2/fulltext",
      description: "The key research study, published in The Lancet, finding the link between lack of access to antibiotics in developing countries and incresed antimicrobial resisitance, referred to in the news article."
    },
    {
      id: 3,
      title: "‘Phage therapy’ could treat some drug-resistant superbug infections, but comes with unique challenges",
      url: "https://theconversation.com/phage-therapy-could-treat-some-drug-resistant-superbug-infections-but-comes-with-unique-challenges-207025",
      description: "This report by academics at the University of Western Australia supports the phage therapy technology that Dr. Sharma brings to Tanzania as an experimental treatment option for drug-resistant infections."
    },
    {
      id: 4,
      ...
      url: "https://pmc.ncbi.nlm.nih.gov/articles/PMC11249277/",
      description: "This academic paper reviews the looming ethicial implications of AI in health care, a key theme of the story."
    },
    {
      id: 5,
      title: "Building evidence for the use of bacteriophages against antimicrobial resistance",
      url: "https://www.who.int/europe/news/item/25-06-2024-building-evidence-for-the-use-of-bacteriophages-against-antimicrobial-resistance",
      description: "This WHO report discusses the potential of phage therapy as an alternative treatment for drug-resistant infections, supporting Dr. Sharma's experimental approach in the story."
    }
  ]
};
