...
export const thisStory: Story = {
  id: 'living-stone-2025-04-24', // Unique identifier for the story
  title: 'Living Stone', // Title of the story
  date: '2025-04-24', // Publication date in YYYY-MM-DD format
  slug: 'living-stone', // URL-friendly version of the title (e.g. title-with-dashes, lowercase)
  excerpt: 'When a team testing carbon-capturing bacteria on Mars discovers that the ancient carbonates are more than just minerals, they face a profound question: what does it mean to be alive?', // Hook sentence for the story, no spoilers!!
  imageUrl: 'assets/living-stone.png', // Path to the story's image
  tags: ["mars", "carbon-cycle", "alien-life", "first-contact", "astrobiology"], // Array of tags related to the story, can be multi-word, lower-case, hyphenated (e.g. ["climate", "health"])  
...
Leila wondered what dreams might fill the mind of living stone.`, // The full story content in Markdown format
  references: [   // Array of up to 5 references to academic papers or reputable news articles that support the science in the story
    {
      ...
      url: "https://www.science.org/doi/10.1126/science.ado9966",
      description: "This 2025 study by Tutolo et al. in Science documents the discovery of siderite (iron carbonate) by the Curiosity rover, providing evidence of an ancient carbon cycle on Mars and helping solve the 'missing carbonate' mystery."
    },
    {
      id: 2,
      title: "Mineral Evolution",
      url: "https://hazen.carnegiescience.edu/research/mineral-evolution",
      description: "This paper by Hazen et al. explores how minerals have evolved over Earth's history in response to biological processes, providing context for the story's concept of mineral-based life forms."
    },
    {
      id: 3,
      title: "Silicon-based life may be more than just science fiction",
      url: "https://www.chemistryworld.com/news/silicon-based-life-may-be-more-than-just-science-fiction/3007091.article",
      description: "This article discusses the scientific basis for silicon-based life forms, supporting the story's premise that life could evolve along non-carbon pathways under the right conditions."
    },
    {
      id: 4,
      title: "Mineral self-organization on a lifeless planet",
      url: "https://www.ncbi.nlm.nih.gov/pmc/articles/PMC5793819/",
      description: "This research explores how minerals can self-organize into complex structures without biological intervention, relevant to the story's concept of mineral-based consciousness."
    },
    {
      id: 5,
      title: "The case for ancient hot springs in Gale Crater, Mars",
      url: "https://www.nature.com/articles/s41467-020-19775-w",
      description: "This study examines evidence for hydrothermal activity in Gale Crater, the same location where Curiosity discovered carbonates, supporting the story's premise of this area once hosting unique life forms."
    }
  ]
};
