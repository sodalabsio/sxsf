...
export const thisStory: Story = {
  id: 'memory-ice', // Unique identifier for the story
  title: 'Memory Ice', // Title of the story
  date: '2025-04-17', // Publication date in YYYY-MM-DD format
  slug: 'memory-ice', // URL-friendly version of the title (e.g. title-with-dashes, lowercase)
  excerpt: 'When a climate scientist discovers impossible ice formations in Antarctic cores, he uncovers an ancient message that could save humanity from itself.', // Hook sentence for the story, no spoilers!!
  imageUrl: 'assets/memory-ice.png', // Path to the story's image
  tags: ["editors-choice", "climate-change", "antarctica", "chemistry"], // Array of tags related to the story, can be multi-word, lower-case, hyphenated (e.g. ["climate", "health"])  
  content: `Dr. James Nakamura pressed his forehead against the eyepiece of the polarized light microscope, squinting at the thin section of ice core. After fifteen hours in the lab, his eyes burned, but he couldn't tear himself away. Something wasn't right.
...
In the ice, memory had endured. And with it, perhaps, a second chance.`, // The full story content in Markdown format
  references: [   // Array of up to 5 references to academic papers or reputable news articles that support the science in the story
    {
      ...
      description: "This groundbreaking study confirms the existence of plastic ice VII, an exotic phase of water that exhibits properties of both solid ice and liquid water. The research demonstrates how water molecules in this phase maintain a crystalline structure while still being able to rotate, providing the scientific foundation for the story's central discovery."
    },
    {
      id: 2,
      title: "Ice cores and climate change - British Antarctic Survey",
      url: "https://www.bas.ac.uk/data/our-data/publication/ice-cores-and-climate-change/",
      description: "This comprehensive resource explains how ice cores serve as archives of Earth's climate history, preserving atmospheric gases and isotopic compositions that reveal past climate conditions. The article details how scientists extract and analyze ice cores from Antarctica, providing context for the research setting in the story."
    },
    {
      id: 3,
      title: "A review of recent advances in engineering bacteria for enhanced CO2 capture and utilization",
      url: "https://pmc.ncbi.nlm.nih.gov/articles/PMC9207427/",
      description: "This review discusses various genetic engineering approaches for improving bacterial CO2 capture and utilization, supporting the story's concept of engineered microorganisms designed for planetary-scale carbon capture. The paper explores how modified bacteria can be used for climate remediation, similar to the ancient technology depicted in the narrative."
    },
    {
      id: 4,
      title: "Physics - Plastic Ice Observed",
      url: "https://physics.aps.org/articles/v18/47",
      description: "This article details the neutron-scattering experiments that confirmed plastic ice VII's existence, explaining how water molecules in this phase remain in a body-centered cubic lattice while rotating. The research provides scientific credibility to the story's premise that plastic ice VII could potentially store information in its unique molecular structure."
    },
    {
      id: 5,
      title: "Two million-year-old ice cores provide first direct observations of ancient climate",
      url: "https://www.princeton.edu/news/2019/11/21/two-million-year-old-ice-cores-provide-first-direct-observations-ancient-climate",
      description: "This article describes how researchers extracted a 2-million-year-old ice core from Antarctica, providing direct observations of prehistoric atmospheric conditions. The study demonstrates the longevity of climate information preserved in ice, supporting the story's concept of ancient climate data being stored in ice cores for thousands of years."
    }
  ]
};
